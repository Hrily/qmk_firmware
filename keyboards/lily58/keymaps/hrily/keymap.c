 ...
 * `-----------------------------------------/       /     \      \-----------------------------------------'
 *                   | RCtrl| LGUI |LOWER | /Space  /       \Enter \  |RAISE | RGUI | RCTRL|
 *                   |      |      |      |/       /         \      \ |      |      |      |
 *                   `----------------------------'           '------''--------------------'
 */
 ...
 [_QWERTY] = LAYOUT( \
  ...
  KC_LSFT,     KC_Z,   KC_X,    KC_C,    KC_V,    KC_B, KC_MS_BTN1,  KC_MS_BTN2, KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_RSFT, \
                             KC_LCTRL, KC_LGUI, MO(_LOWER), KC_SPC,  KC_ENT, MO(_RAISE), KC_RGUI, KC_RCTRL \
),
/* LOWER
 * ,-----------------------------------------.                    ,-----------------------------------------.
 * |      |      |      |      |      |      |                    |      |      |      |      |  -   |  +   |
 ...
 */
[_LOWER] = LAYOUT( \
  _______, _______, _______, _______, _______, _______,                   _______, _______, _______, _______, KC_MINS, KC_PLUS, \
  KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,                     KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,  KC_RBRC, \
